    ...
    ({
      ...
      navbar: {
        items: [
          ...
          {
            href: 'https://github.com/SaadAslam58',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Panaversity Hackathon Participant. Built with Docusaurus.`,
      },
      prism: {
